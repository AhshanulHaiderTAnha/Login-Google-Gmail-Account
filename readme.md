...
In this step we need google client id and secret that way we can get information of other user. so if you don't have google app account then you can create from here  you can find bellow screen :  

Google Developers Console : https://console.cloud.google.com/apis/dashboard
...
Step 5 : Create DB and update env
